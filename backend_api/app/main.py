...
from app.routes import artifacts, auth, catalog, dashboard, dataset, explainability, governance, health, metrics, observability, predictions, runs
...
for router in (health.router, auth.router, dashboard.router, runs.router, catalog.router, dataset.router,
               ...
               artifacts.router, governance.router):
