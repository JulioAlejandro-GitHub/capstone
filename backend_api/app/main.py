...
from app.routes import local_execution, assessments, analysis, artifacts, auth, catalog, cell_analysis, cell_classification, dashboard, dataset, dataset_versions, explainability, governance, health, metrics, observability, predictions, runs, scientific, scientific_validation
...
for router in (local_execution.router, assessments.router, health.router, auth.router, dashboard.router, runs.router, catalog.router, dataset.router,
