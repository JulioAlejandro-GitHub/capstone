"""Align summary-integrity trigger with the canonical per-image contract."""
...
def downgrade():
    # The migration is an in-place integrity-contract alignment. Keeping the
    # stricter function is safer than restoring the transient mismatched body.
    pass
