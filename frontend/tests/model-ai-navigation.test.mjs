...
test('deployments conecta smoke, publicación formal y rollback inmutable',()=>{for(const token of ['getDeployments','smokeTestDeployment','publishModelVersionToProduction','transitionDeployment','rollbackDeployment','confirm_production'])assert.match(deployments,new RegExp(token));});
