#!/usr/bin/env python3
"""E6 campaign evaluate entrypoint; legacy inventory is read-only and exposes ambiguity."""
...
def build_evaluate_command(run: TrainingRun, *, threshold, split, purpose, protocol, seed):
    import json
    command = [sys.executable, "-m", "src.evaluate",
...
def main() -> int:
    ...
    return governed_main("evaluate", batch=True)
