...
-- Running upgrade 20260914_01 -> 20260914_02
...
ALTER FUNCTION experiment_require_owner() SET search_path = public, pg_catalog;

ALTER FUNCTION experiment_reservation_guard() SET search_path = public, pg_catalog;

ALTER FUNCTION execution_event_immutable() SET search_path = public, pg_catalog;

ALTER FUNCTION train_revision_binding_guard() SET search_path = public, pg_catalog;

ALTER FUNCTION campaign_attempt_guard() SET search_path = public, pg_catalog;

UPDATE alembic_version SET version_num='20260914_02' WHERE alembic_version.version_num = '20260914_01';
